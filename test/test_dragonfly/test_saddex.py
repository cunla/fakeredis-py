...
def test_saddex_expire_members(r: ClientType):
    ...
    # SADDEX returns only the number of newly added members, but it still applies the expiry to members that were
    # already in the set, so m3 expires along with m1/m2.
